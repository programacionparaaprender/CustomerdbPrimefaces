...
(
  idcurrency INT NOT NULL IDENTITY(1,1),--AUTO_INCREMENT,
...
(
  idcountry INT NOT NULL IDENTITY(1,1),--AUTO_INCREMENT,
  ...
  CONSTRAINT fk_cb_country_idcurrency FOREIGN KEY (idcurrency)
      REFERENCES cb_currency (idcurrency), 
	  --MATCH SIMPLE
...
(
  idaddresses INT NOT NULL IDENTITY(1,1),--AUTO_INCREMENT,
...
(
  idaddress INT NOT NULL IDENTITY(1,1),--AUTO_INCREMENT,
  idaddresses INT,
  address VARCHAR(500),
  ...
  CONSTRAINT fk_cb_address_idaddresses FOREIGN KEY (idaddresses)
      REFERENCES cb_addresses (idaddresses), 
	  --MATCH SIMPLE
      --ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT fk_cb_address_idcountry FOREIGN KEY (idcountry)
      REFERENCES cb_country (idcountry) 
	  --MATCH SIMPLE
      --ON UPDATE NO ACTION ON DELETE NO ACTION
)
--ENGINE=InnoDB
...
(
  idpaymentmethod INT NOT NULL IDENTITY(1,1),--AUTO_INCREMENT,
...
(
  idcustomer INT NOT NULL IDENTITY(1,1),--AUTO_INCREMENT,
  identerprise INT,
  ...
  CONSTRAINT fk_cb_customer_identerprise FOREIGN KEY (identerprise)
      REFERENCES cb_enterprise (identerprise), 
	  --MATCH SIMPLE
      --ON UPDATE NO ACTION ON DELETE NO ACTION,
  ...
  CONSTRAINT fk_cb_customer_idpaymentmethod FOREIGN KEY (idpaymentmethod)
      REFERENCES cb_paymentmethod (idpaymentmethod), 
	  --MATCH SIMPLE
      --ON UPDATE NO ACTION ON DELETE NO ACTION,
